            ...
            render: (gvc, widget, setting, hoverID) => {
                ...
                function circlesGene(style) {
                    ...
                    for (let i = 0; i < style.count; i++) {
                        ...
                        gvc.addStyle(`.circles li:nth-child(${i + 1}) {
                    ...
                    view: () => {
                        return `
                            ...
                            if (glitter.ut.frSize({ lg: false }, true)) {
                                ...
                                widget.data.lottie.map((x) => {
                                    h += `<div class="col-6 mt-3 d-flex justify-content-center" style="">
                            ...
                            return h;
                                ...
                                <div class="col-md-7">
                                    ${glitter.print(() => {
                            let h = '';
                            const bi = Number(window.$(window).width()) / 1920;
                            if (glitter.ut.frSize({ lg: true }, false)) {
                                widget.data.lottie.map((x) => {
                                    h += `<div
                                                        class=""
                                                        style="position: absolute; top: ${x.top}%; right: ${x.right}%; z-index:${x.displayOrder}"
                                                    >
                                                        <lottie-player
                                                            autoplay
                                                            loop
                            ...
                            a += `<div class="mt-2">${Editor.toggleExpand({
                                ...
                                innerText: gvc.map([
                                    ...
                                    `<div class="alert-dark alert p-2 mt-2">
                                        ${glitter.htmlGenerate
                                        .styleEditor(widget.data[x.key].web)
                                        .editor(gvc, widget, '設計樣式')}
                                    </div>`,
                                    glitter.htmlGenerate.editeInput({
                                        gvc: gvc,
                                        title: `手機板 - 標題`,
                    ...
                    view: () => {
                        ...
                        >
                            ...
                            return {
                                bind: `project`,
                                view: () => {
                                    return `<h2 class="h1 py-4 text-center">${widget.data.title}</h2>
                                        ...
                                        let tmp = '';
                                        widget.data.service.map((l) => {
                                            tmp += `
                                                                        <div class="swiper-slide h-auto pb-3">
                                                                            <article class="card h-100 border-0 shadow-sm mx-2">
                                                                                <div class="position-relative">
                                                                                    <div
                                                                                        style="width: 100%; height: 350px; background-size: cover; background-position: center center; background:url(${l.img}); "
                                                                                    ></div>
                                                                                </div>
                                                ...
                                                console.log(l.tag);
                                                l.tag.map((t) => {
                                                    let tag = widget.data.tag.find((g) => g.title == t);
                                                    console.log(tag);
                                                    if (tag) {
                                                        tmp += `
                                                                                                        <a
