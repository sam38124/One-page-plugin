...
!(function () {
  ...
  null !== (e = document.querySelector('[data-bs-toggle="mode"]')) &&
    ...
    e.addEventListener("click", function (e) {
      t.checked
        ? (root.classList.add("dark-mode"), window.localStorage.setItem("mode", "dark"))
        : (root.classList.remove("dark-mode"), window.localStorage.setItem("mode", "light"));
    })),
        ...
        for (var t = 0; t < e.length; t++) {
          ...
          switch (r) {
            ...
            case "time":
              ...
              break;
            case "custom":
              new Cleave(e[t], { delimiter: o, blocks: a, numeral: n, numeralIntegerScale: parseInt(e[t].dataset.numeral) });
              break;
            default:
              console.error(
                "Sorry, your format " +
        ...
        for (
          var e = function (e) {
              ...
              a.addEventListener("click", function (e) {
                s =
                  "play" === s
                    ? (e.currentTarget.classList.add("ap-pause"), r.play(), requestAnimationFrame(f), "pause")
              ...
              0 < r.readyState
                ...
                n.addEventListener("change", function () {
                  (r.currentTime = n.value), r.paused || requestAnimationFrame(f);
                }),
                e.addEventListener("input", function (e) {
                  e = e.target.value;
                  r.volume = e / 100;
