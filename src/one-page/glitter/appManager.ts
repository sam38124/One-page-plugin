...
<span class="mt-2">加載中...</span>
 ...
 <button class="btn btn-warning   " style="color:black;width: calc(50% - 5px);" onclick="${
                                        gvc.event(()=>{
...
function deleteEvent(gvc: GVC, dd: any) {
...
function appCreate(gvc: GVC, widget: HtmlJson, setting: HtmlJson[], hoverID: string[]) {
...
function paying(item: any) {
    const glitter = (window as any).glitter
    return glitter.ut.frSize(
        {
            sm: /*html*/ ` <div class="position-relative mx-5">
            ...
            >
              <div class="swiper-wrapper">
                ...
                var html = "";
                item.map(function (dd: any, index: number) {
                    html += /*html*/ `
...
class Service {
    ...
    public static official(gvc: GVC) {
