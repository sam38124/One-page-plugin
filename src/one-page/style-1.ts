                            ...
                            >
                                <div class="container px-3">
                                    <a
                                        ...
                                        style="cursor:pointer"
                                    >
                                        <img class="me-2" src="${nav.logo.url}" width="30" style="${nav.logo.style}" />${glitter.ut.frSize(
                            { sm: nav.title.pc },
                            nav.title.phone
                        )}
                                    </a>
      ...
      >
        ...
        <div class="row w-100 mx-lg-5 my-3 px-3 px-xl-5 d-flex justify-content-center">
            ...
            <div class="row">
              <div class="col-12 col-lg-6 mt-2">
                <ul class="mb-4">
                  ${glitter.print(function () {
                      var tmp = '';
                      price.main.list.map((l: any) => (tmp += /*html*/ /*html*/ `<li>${l}</li> `));
                      return tmp;
                  })}
                </ul>
              ...
              ${
                  price.main.lottie.split('.').pop() === 'json'
                      ? `
                <lottie-player autoplay loop mode="normal" src="${price.main.lottie}" style="width: ${glitter.ut.frSize(
                            { sm: 360 },
                            200
                        )}px;">`
                      : `
          ...
          <div class="col-12 col-lg-4 card card-price">
            ${glitter.ut.frSize({ sm: /*html*/ `<h3 class="mb-4">${price.sub.title}</h3>` }, /*html*/ `<h2>${price.sub.title}</h2>`)}
            <div class="d-flex flex-column"></div>
            <ul>
              ${glitter.print(function () {
                  var tmp = '';
                  price.sub.list.map((l: any) => (tmp += /*html*/ /*html*/ `<li style="list-style:none;">${l}</li> `));
                  return tmp;
              })}
            </ul>
            <div class="dollar-line">
    ...
    return {
        ...
        clientService: {
            ...
            render: (gvc: GVC, widget: HtmlJson, setting: HtmlJson[], hoverID: string[]) => {
                ...
                widget.data.title =
                    widget.data.title ??
                    /*html*/ `<p class="lead mb-3">沒有那麼多的預算</p>
                ...
                return {
                    view: () => {
                        return /*html*/ `<section class="container" id="glitterBase">
                                                    ...
                                                    tmp += /*html*/ `
                                                        <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
                                                            <h2 class="accordion-header" id="q${i}-heading">
                                                                <button
                                                                    class="accordion-button shadow-none rounded-3 fs-5 ${
                                                                        i != 0 ? `collapsed` : ``
                                                                    }"
                                                                    type="button"
        ...
        All Rights Reserved.`;
                ...
                return {
                    view: () => {
                        ...
                        return /*html*/ `<footer class="footer dark-mode bg-dark  pb-4 pb-lg-5 border-top" id="footer">
            ...
            render: (gvc: GVC, widget: HtmlJson, setting: HtmlJson[], hoverID: string[]) => {
                ...
                return {
                    view: () => {
                        ...
                        return /*html*/ `<section class="container pt-2 pt-lg-0 pb-5 mb-md-4 mb-lg-5">
                    ...
                    view: () => {
                        ...
                        return gvc.bindView(() => {
                            return {
                                bind: id,
                                view: () => {
                                    return /*html*/ `<h2 class="h1 mb-4 text-center">${template.title}</h2>
                                ...
                                onCreate: () => {
                                    try {
                                        ...
                                        imagesLoaded(document.querySelector('#' + gvc.id(id)), function (instance: any) {
                                            ($('.isot') as any).isotope({ filter: ':not("*")' }),
