                            ...
                            Editor.toggleExpand({
                                gvc: gvc, title: "手機版", data: widget.data.mobile.m, innerText: gvc.map([
                                    ...
                                    Editor.toggleExpand({
                                        ...
                                        innerText: widget.data.mobile.m.btn.map((data: any, index: number) => {
                                            return gvc.map([
                                                Editor.minusTitle(
                                                    "按鈕:" + (index + 1),
                                                    gvc.event(() => {
...
${ClickEvent.editer(gvc, widget, data.btn, {
                                ...
                                Editor.toggleExpand({
                                    ...
                                    title: "列表項目",
                                    data: data,
                                    innerText: data.list.map((data2: any, index: number) => {
                    ...
                    editor: () => {
                        ...
                        return gvc.map([
                            ...
                            Editor.toggleExpand({
                                ...
                                innerText: widget.data.tag.map((data: any, index: number) => {
                                    return Editor.toggleExpand({
                                        gvc: gvc,
...
${dd.list.map((d2: any, index: number) => {
                                                        return glitter.htmlGenerate.editeInput({
                                                            gvc: gvc,
                ...
                `;
                    ...
                    editor: () => {
                        ...
                        return glitter.htmlGenerate.editeInput({
                            ...
                            gvc: gvc,
                            title: "其他服務",
                            array: widget.data.service.map((dd: any, index: number) => {
                                return {
                                    title: dd.name || `區塊:${index + 1}`,
                                    expand: dd,
                                    innerHtml: glitter.htmlGenerate.editeInput({
            ...
            ${glitter.print(function () {
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      role="tab"
                      onclick="${gvc.event(()=>{
                                                ($(".isot") as any).isotope({ filter: a.className })
                                            })}"
                    >
                      ${a.title}
                    </button>
