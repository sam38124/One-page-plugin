...
${Editor.uploadImage({
    ...
    <div class="d-flex w-100">
        ...
        <input class="flex-fill form-control ms-2" style="width: 100px;" value="${dd.imgWidth ?? "24px"}" onchange="${gvc.event((e) => {
                                    dd.imgWidth = e.value;
                                    widget.refreshAll();
                                })}">
    </div>
    <div class="d-flex w-100">
        ...
        <input class="flex-fill form-control ms-2" style="width: 100px;" value="${dd.imgHeight ?? "24px"}" onchange="${gvc.event((e) => {
...
<div class="text-black align-items-center justify-content-center d-flex p-1 rounded mt-3" style="border: 2px dashed black;" onclick="${gvc.event(() => {
