                                                                    ...
                                                                    view: () => {
                                                                        return `
                                                                            ...
                                                                            refreshCart()
                                                                                ...
                                                                                <img style="width: 24px;height: 24px;" src="${new URL('https://homee-ai.github.io/glitter-htmlExtension/src/img/component/plusCircle.svg', import.meta.url)}" onclick="${gvc.event((e: any) => {
                                                                    item.qty++;
                                                                    item.subtotal = item.qty * item.price;
                                                                    refreshCart()
                                                                })}">                                        
