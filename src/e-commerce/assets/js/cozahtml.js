            ...
            <div class="p-t-33">
              ${
                data.size && data.size.length != 0
                  ? /*html*/ `<div class="flex-w flex-r-m p-b-10">
                      <div class="size-203 flex-c-m respon6">${glitter.share.language.size}</div>
                        ...
                        <div class="rs1-select2 bor8 bg0">
                          <select class="js-select2" name="time">
                            ${glitter.print(function () {
                              var tmp = "";
                              data.size.map((si, i) => {
                                tmp += /*html*/ `<option value="${si}" ${i == 0 ? `selected` : ``}>${si}</option>`;
                              });
                              return tmp;
                            })}
                          </select>
              ...
              ${
                data.color && data.color.length != 0
                  ? /*html*/ `<div class="flex-w flex-r-m p-b-10">
                      <div class="size-203 flex-c-m respon6">${glitter.share.language.color}</div>
