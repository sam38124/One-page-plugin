export class CozaHTML {
    private sort: (data:any) => string;
    private color: (data:any) => string;
    private quickView: (data:any) => string;

    constructor() {
        this.sort = function (data:string) {
            let list:any = {
      ...
      `;
        ...
        <div class="col-md-6 col-lg-5 p-b-30">
          <div class="p-r-50 p-t-5 p-lr-0-lg">
            ...
            <span class="mtext-106 cl2 price-selected" data-price="${data.price}"> $${(data.price as number).toLocaleString()}</a></span>
