          ...
          <div class="container py-5 px-lg-5">
            <div class="row gy-5 gx-4 pt-5">
                    ...
                    footer.map.map((m:any) => {
                        ...
                        ${glitter.print(function () {
                            ...
                            m.listData.list.map((l:any) => {
                                tmp += /*html*/ `<a class="btn btn-link" href="${l.link}" >${l.name}</a>`;
                            });
                            return tmp;
                        })}
                  </div>`;
              ...
              <div class="col-md-6 col-lg-3">
                ...
                ${glitter.print(function () {
                                var tmp = "";
                                footer.contactInf.inf.map((f:any) => {
                                    tmp += /*html*/ ` <p class="mb-2"><i class="${f.icon} text-center" style="width:2.5em"></i>${f.title}</p> `;
                                });
                                return tmp;
                            })}
