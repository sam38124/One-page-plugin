              ...
              ${glitter.print(function () {
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="${0.2 + 0.2 * j}s">
                      <div class="position-relative shadow rounded border-top border-5 border-${l.highlight ? "secondary" : "primary"}">
                        <div
                          class="d-flex align-items-center justify-content-center position-absolute top-0 start-50 translate-middle bg-${l.highlight ? "secondary" : "primary"} rounded-circle"
                                ...
                                return {
                                    ...
                                    innerHtml: gvc.map([
                                        ...
                                        Editor.arrayItem({
                                            ...
                                            gvc: gvc,
                                            title: '功能清單',
                                            array: dd.detail.map((detail, index) => {
                                                return {
