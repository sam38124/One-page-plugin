export class Qrcode {
    public static html(orderID: string, productName: string, sku: string, spec: string, qty: string, packageCount: string, shipNumber: string,l:string,w:string,h:string,image:string) {
        return `<html>
<head>
