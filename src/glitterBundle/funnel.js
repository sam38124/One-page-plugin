...
export class Funnel {
    ...
    ensure = (argument, message = 'This value was promised to be there.') => {
        if (argument === undefined || argument === null) {
            throw new TypeError(message);
        }
        return argument;
    };
    encodeFileBase64 = (files, callback) => {
        var file = files;
    ...
    cutString = (text, limit) => (text.length > limit ? text.substring(0, limit) + '...' : text);
}
