...
BackendPlugin.createPlugin((gvc) => {
    ...
    saasConfig.api.getPrivateConfig(saasConfig.config.appName, "glitter_notifyConfig").then((r) => {
...
${dd.html}
                ...
                <div class="d-flex w-100">
                    ...
                    saasConfig.api.setPrivateConfig(saasConfig.config.appName, "glitter_notifyConfig", vm.data).then((r) => {
                        setTimeout(() => {
