...
BackendPlugin.createPlugin((gvc) => {
    ...
    saasConfig.api.getPrivateConfig(saasConfig.config.appName, "glitter_loginConfig").then((r) => {
...
<select
                                        ...
                                        return `<option value="${dd.tag}" ${vm.data.link === dd.tag ? `selected` : ``}>
                                                    ${dd.group}-${dd.name}
                                                </option>`;
                                    })}
                                        </select>`;
...
<select
                                        ...
                                        return `<option value="${dd.tag}" ${vm.data.forget === dd.tag ? `selected` : ``}>
                                                    ${dd.group}-${dd.name}
                                                </option>`;
                                    })}
                                        </select>`;
...
<button class="btn-warning btn" style="color:black;" onclick="${gvc.event(() => {
                    ...
                    saasConfig.api.setPrivateConfig(saasConfig.config.appName, "glitter_loginConfig", vm.data).then((r) => {
                        setTimeout(() => {
