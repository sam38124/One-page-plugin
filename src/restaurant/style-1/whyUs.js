...
Plugin.createComponent(import.meta.url, (glitter, editMode) => {
    return {
        ...
        render: (gvc, widget, setting, hoverID) => {
            ...
            widget.data.desc = widget.data.desc ?? "從一開始的產品規劃與需求傾聽，再到頁面、Logo設計、UI／UX，最後的軟體開發與部署";
            widget.data.title = widget.data.title ?? "我們擅長的領域";
            widget.data.desc = widget.data.desc.replace(/\n/g, "<br>");
            return {
                view: () => {
                                    ...
                                    <section id="banner" class="why-us">
                                        <div class="container" data-aos="fade-up">
                                            <div class="section-title">
                                                <h2>${banner.title}</h2>
                                                <p style="white-space:normal;word-wrap:break-word;word-break:break-all;">${banner.desc.replace(/\n/g, '<br>')}</p>
                                            </div>
