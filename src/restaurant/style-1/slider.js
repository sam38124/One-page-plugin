...
Plugin.createComponent(import.meta.url, (glitter, editMode) => {
    return {
        ...
        render: (gvc, widget, setting, hoverID) => {
            widget.data.desc = widget.data.desc ?? '提供原創活動的餐點服務與流程';
            widget.data.title = widget.data.title ?? '活動專案';
            widget.data.bg = widget.data.bg ?? ScriptStyle1.getRout("assets/img/events-bg.jpg");
                    ...
                    return gvc.bindView({
                        ...
                        view: () => {
                            ...
                            return `
                                ...
                                let tmp = "";
                                slider.dataList.list.map((l) => {
                                    tmp += `
                                                            <div class="swiper-slide">
                                                                <div class="row event-item align-items-center">
                                                                    <div class="col-lg-6 about-img" data-aos="zoom-in" data-aos-delay="100">
                                                                        <img src="${l.img}" class="img-fluid " alt="" />
                                                                    </div>
                                                                    <div class="col-lg-6 pt-4 pt-lg-0 content">
                                                                        <h3>${l.title}</h3>
                                                                        <div class="price">
                                                                            <p><span>${l.price}</span></p>
                                                                        </div>
