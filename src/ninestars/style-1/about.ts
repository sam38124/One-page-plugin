        ...
        render: (gvc: GVC, widget: HtmlJson, setting: HtmlJson[], hoverID: string[]) => {
            return {
                view:()=>{
                    ...
                    widget.data.img = widget.data.img ?? ScriptStyle1.getRout("assets/img/about-img.svg");
          ...
          <div class="container mt-5">
            <div class="row justify-content-between">
              <div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
                <img src="${about.img}" class="img-fluid" alt="" data-aos="zoom-in" />
              </div>
              <div class="col-lg-6 pt-5 pt-lg-0">
                <h3 data-aos="fade-up">${about.title}</h3>
                <p data-aos="fade-up" data-aos-delay="100">${about.desc}</p>
                <div class="row">
                  ${glitter.print(function () {
                                var tmp = "";
                                about.list.map((l:any, i:number) => {
                                    tmp += /*html*/ `
